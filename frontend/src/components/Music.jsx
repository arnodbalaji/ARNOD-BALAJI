import { Music, Youtube, MessageCircle, ArrowUpRight } from "lucide-react";
import { Reveal, SectionHeading } from "./Reveal";
import MANDIR_CONFIG from "../config/mandirConfig";

const ICONS = { music: Music, youtube: Youtube, chat: MessageCircle };
      ...
      <div className="relative max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {MANDIR_CONFIG.musicLinks.map((link, i) => {
            const Icon = ICONS[link.icon] || Music;
            return (
              <Reveal key={link.label} delay={0.05 * i}>
                ...
                >
                  <div className="flex items-center justify-between">
                    <span className="w-10 h-10 rounded-xl bg-[#ff6b00]/10 border border-[#ff6b00]/30 flex items-center justify-center text-[#ff8c00] group-hover:scale-110 transition-transform duration-300">
                      <Icon size={18} />
                    </span>
